...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<div class="item-label">租户账号</div> 
					<input  name="zuhuzhanghao"  placeholder="请输入租户账号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					<div class="item-label">租户姓名</div> 
					<input  name="zuhuxingming"  placeholder="请输入租户姓名" class="form-control-i">
				</div>
                <div class="list-item">
