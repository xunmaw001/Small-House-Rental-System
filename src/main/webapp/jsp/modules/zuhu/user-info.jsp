...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑租户</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑租户</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>租户账号</label>
					<input name="zuhuzhanghao" readonly id="zuhuzhanghao" name="zuhuzhanghao" class="form-control" placeholder="请输入租户账号">
				</div>
				<div class="form-item">
					<label>租户姓名</label>
	...
	<script>
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				httpJson("zuhu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
