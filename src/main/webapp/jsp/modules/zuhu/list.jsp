...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">租户管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>租户管理</span></li>
				<li class="breadcrumb-item-two"><span>租户列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>租户账号</label>
					<input type="text" id="zuhuzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入租户账号" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#zuhuzhanghaoSearch').val() != null && $('#zuhuzhanghaoSearch').val() != ''){
				searchForm.zuhuzhanghao ="%" +  $('#zuhuzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("zuhu/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				zuhuzhanghao : searchForm.zuhuzhanghao,	
			},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zuhu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zuhu");
