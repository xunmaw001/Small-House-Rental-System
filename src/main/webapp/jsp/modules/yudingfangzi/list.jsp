...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">预定房子管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>预定房子列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
	...
	<script>
		...
		function setDataRow(item,number){
			...
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'hetongxinxi','','','')");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yudingfangzi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"yudingfangzi");
