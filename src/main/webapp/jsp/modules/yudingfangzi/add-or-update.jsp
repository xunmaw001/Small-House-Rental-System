...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑预定房子</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>预定房子管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑预定房子</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>预定时间</label>
					<input id="yudingshijian-input" class="date" name="yudingshijian" size="20" type="text" readonly placeholder="请选择预定时间">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yudingfangzi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("yudingfangzi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yudingfangzi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yudingfangzi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.zuhuzhanghao != null && res.data.zuhuzhanghao != ''){
							$('#zuhuzhanghao').val(res.data.zuhuzhanghao)
							$("#zuhuzhanghao").attr('readonly','readonly');
						}
						if(res.data !=null && res.data.zuhuxingming != null && res.data.zuhuxingming != ''){
