...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<div class="item-label">房东账号</div> 
					<input  name="fangdongzhanghao"  placeholder="请输入房东账号" class="form-control-i">
				</div>
				<div class="list-item">
					<div class="item-label">房东姓名</div> 
					<input  name="fangdongxingming"  placeholder="请输入房东姓名" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					...
					<input  name="shenfenzhenghao"  placeholder="请输入身份证号" class="form-control-i">
				</div>
				<div class="list-item">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "fangdong/register";
				$.ajax({ 
					type: "POST",
					url: url,
