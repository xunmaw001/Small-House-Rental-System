...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">房东管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>房东管理</span></li>
				<li class="breadcrumb-item-two"><span>房东列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>房东账号</label>
					<input type="text" id="fangdongzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入房东账号" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>房东姓名</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#fangdongzhanghaoSearch').val() != null && $('#fangdongzhanghaoSearch').val() != ''){
				searchForm.fangdongzhanghao ="%" +  $('#fangdongzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("fangdong/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				fangdongzhanghao : searchForm.fangdongzhanghao,	
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"fangdong");
