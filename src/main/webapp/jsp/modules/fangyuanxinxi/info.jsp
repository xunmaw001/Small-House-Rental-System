		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="shifouzhuangxiu" name="shifouzhuangxiu" class="form-control" v-model="ruleForm.shifouzhuangxiu" readonly>
				</div>
				<div class="form-item">
					<label>面积/㎡</label>
				...
				<div class="form-item">
					...
					<input id="chaoxiang" name="chaoxiang" class="form-control" v-model="ruleForm.chaoxiang" readonly>
				</div>
				...
				<div class="form-item-file">
					<label>配套详情</label>
					<script id="peitaoxiangqingEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.peitaoxiangqing != null && ruleForm.peitaoxiangqing != 'null' && ruleForm.peitaoxiangqing != ''){
				var mes = '' + ruleForm.peitaoxiangqing;
				var peitaoxiangqingUeditor = UE.getEditor('peitaoxiangqingEditor');
				peitaoxiangqingUeditor.ready(function() {
					peitaoxiangqingUeditor.setContent(mes);
					peitaoxiangqingUeditor.setDisabled('fullscreen');
				});
			}
