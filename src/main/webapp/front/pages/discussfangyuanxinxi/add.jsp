			...
			<div class="data-add-container" :style='{"width":"100%","padding":"40px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#efe4d4","alignItems":"center","borderWidth":"0 0 0px","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","display":"flex","borderStyle":"solid"}' class="layui-form-item">
						...
						<img :style='{"minHeight":"80px","width":"150px","margin":"0 10px 0 0","objectFit":"cover","borderRadius":"8px","height":"auto"}' v-if="detail.avatarurl" id="avatarurlImg" :src="baseurl+detail.avatarurl">
						<input v-if="detail.avatarurl" type="hidden" :value="detail.avatarurl" id="avatarurl" name="avatarurl" />
						<button v-if="!ro.avatarurl" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0","borderColor":"#666","color":"#333","outline":"none","borderRadius":"8px","background":"none","borderWidth":"1px","width":"auto","fontSize":"12px","lineHeight":"36px","borderStyle":"dashed","height":"36px"}' type="button" class="layui-btn btn-theme" id="avatarurlUpload">
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('discussfangyuanxinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('discussfangyuanxinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
