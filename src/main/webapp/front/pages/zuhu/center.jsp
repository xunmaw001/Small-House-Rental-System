				...
				<div :style='{"width":"100%","padding":"0","margin":"0","background":"url() repeat-x center top","flex":"1"}' class="right-container">
					<form :style='{"padding":"20px 0 0","boxShadow":"0px 0px 0px #eee","borderColor":"#ddd","flexWrap":"wrap","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}' class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"padding":"0 15px","color":"#992298","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"15px","minWidth":"90px","fontWeight":"500"}' class="layui-form-label">租户账号</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#555","outline":"none","borderRadius":"0px","borderWidth":"0px","background":"#fff","width":"100%","fontSize":"14px","lineHeight":"32px","borderStyle":"solid","height":"32px"}' type="text" readonly="readonly" name="zuhuzhanghao" name="zuhuzhanghao" id="zuhuzhanghao" placeholder="租户账号" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"padding":"0 15px","color":"#992298","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"15px","minWidth":"90px","fontWeight":"500"}' class="layui-form-label">租户姓名</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#555","outline":"none","borderRadius":"0px","borderWidth":"0px","background":"#fff","width":"100%","fontSize":"14px","lineHeight":"32px","borderStyle":"solid","height":"32px"}' type="text"  name="zuhuxingming" name="zuhuxingming" id="zuhuxingming" placeholder="租户姓名" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"padding":"0 15px","color":"#992298","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"15px","minWidth":"90px","fontWeight":"500"}' class="layui-form-label">手机</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#555","outline":"none","borderRadius":"0px","borderWidth":"0px","background":"#fff","width":"100%","fontSize":"14px","lineHeight":"32px","borderStyle":"solid","height":"32px"}' type="text"  name="shouji" name="shouji" id="shouji" placeholder="手机" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"padding":"0 15px","color":"#992298","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"15px","minWidth":"90px","fontWeight":"500"}' class="layui-form-label">身份证</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#555","outline":"none","borderRadius":"0px","borderWidth":"0px","background":"#fff","width":"100%","fontSize":"14px","lineHeight":"32px","borderStyle":"solid","height":"32px"}' type="text"  name="shenfenzheng" name="shenfenzheng" id="shenfenzheng" placeholder="身份证" autocomplete="off" class="layui-input">
						</div>
