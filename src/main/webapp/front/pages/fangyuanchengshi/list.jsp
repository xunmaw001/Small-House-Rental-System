		...
		<script>
			...
			layui.use(['form', 'layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate', 'slider'], function() {
				...
				function pageList() {
					...
					// 获取列表数据
					http.request('fangyuanchengshi/list', 'get', param, function(res) {
